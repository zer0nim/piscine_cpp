...
void	Bureaucrat::executeForm(AForm const &form) {
    ...
    {
        std::cout << "cannot execute " << form.getName() << " because the form is not signed !" << std::endl;
    }
    catch(const AForm::GradeTooLowException& e)
    {
        std::cout << "cannot execute " << form.getName() << " because the required grade is " << form.getReqExecGrade() << std::endl;
    }
}
